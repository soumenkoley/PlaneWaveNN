...
nTheta = 100; % numbver of points along theta from [0,pi]
nPhi = 500; % number of points in phi from [0, 2pi]
rCav = 20; % radius of cavity in meters
zCav = -250; % location of cavity in z, (x,y) assumed to be zero
% note that since it is half space, the cavity is no more at the center
% so zCav = -250

% wave direction in degrees
thetaW = 90; % this can be different, results will vary becauase of spherical asymmetry
phiW = 0; % again can be anything
