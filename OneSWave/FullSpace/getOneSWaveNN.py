...
R = 8000
rCav, zCav = 20.0, -250.0
thetaW, phiW = 90.0, 0.0
wComp = 'SV'
vS, rho = 3000.0, 2800.0
G = 6.67430e-11
r1, r2 = rCav, R

f_max = fAll.max()
nR, nTheta, nPhi, grid_info = compgrid(R, vS, f_max)
print(f"\n--- Grid resolution (Full-space S-wave) ---")
...
pointsPerRegion = [int(nR*0.1), int(nR*0.1), int(nR*0.8)]
...
for idx, ax in enumerate(axes):
    ...
    ax.set_title(f'{components[idx]} Component (Full-space S-wave)')
