...
nTheta = 200; % number of points in theta from, [0, pi]
nPhi = 500; % number of points in phi from [0, 2pi]
rCav = 20; % radius of cavity
zCav = 0; % z coordinate of cavity, since it is full sopace, the caviuty
% can be at the centre of the cavity
% wave properties
...
bounds = [0,rCav,R];
% note that 10+290 = 300=nR, this must be followed
